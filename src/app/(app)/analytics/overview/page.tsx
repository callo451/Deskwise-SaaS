  ...
  return (
    <div className="flex-1 space-y-6 p-8">
      ...
      <Tabs defaultValue="service-desk" className="space-y-6">
        <TabsList className="bg-gradient-to-r from-accent/30 to-accent/10 p-1 border-2 shadow-md">
          <TabsTrigger value="service-desk" className="data-[state=active]:bg-white data-[state=active]:shadow-sm font-medium">Service Desk</TabsTrigger>
          <TabsTrigger value="operations" className="data-[state=active]:bg-white data-[state=active]:shadow-sm font-medium">Operations</TabsTrigger>
          <TabsTrigger value="assets" className="data-[state=active]:bg-white data-[state=active]:shadow-sm font-medium">Assets</TabsTrigger>
          <TabsTrigger value="performance" className="data-[state=active]:bg-white data-[state=active]:shadow-sm font-medium">Performance</TabsTrigger>
        </TabsList>
