...
export default function UnifiedTicketDetailPage({
  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-50 to-gray-100 dark:from-gray-950 dark:to-gray-900 flex items-center justify-center">
          ...
          <TabsContent value="comments" className="mt-0">
            <Card className="border-2">
              <CardHeader>
                ...
                <CardDescription>Collaborate with your team and stakeholders</CardDescription>
              </CardHeader>
              <CardContent>
          ...
          <TabsContent value="attachments" className="mt-0">
            <Card className="border-2">
              <CardHeader>
                ...
                <CardDescription>Upload and manage ticket attachments</CardDescription>
              </CardHeader>
              <CardContent>
          ...
          <TabsContent value="time" className="mt-0">
            <Card className="border-2">
              <CardHeader>
                ...
                <CardDescription>Track time spent and billable hours</CardDescription>
              </CardHeader>
              <CardContent>
                <TimeTrackingTab
                  ticketId={ticket._id.toString()}
